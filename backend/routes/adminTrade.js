...
router.put('/settings', async (req, res) => {
  try {
    ...
    // MT5 Feature Toggles
    if (enablePartialClose !== undefined) settings.enablePartialClose = enablePartialClose
    if (enableTrailingStop !== undefined) settings.enableTrailingStop = enableTrailingStop
    if (stopOutOrder !== undefined) settings.stopOutOrder = stopOutOrder
    if (includeFloatingPnlInMargin !== undefined) settings.includeFloatingPnlInMargin = includeFloatingPnlInMargin
